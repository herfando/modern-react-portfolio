    ...
    return (
      ...
      <div className="flex gap-16 max-[393px]:flex-col max-[393px]:gap-10">
        ...
        <div className="flex flex-col gap-6 basis-[256px] shrink-0 max-[393px]:basis-[156px]">
          <div className="industry-tab flex gap-2 cursor-pointer items-center" data-target="fintech">
            <div className="indicator w-[4px] h-[34px] bg-[#ff623e] rounded-[100px]"></div>
            <h3 className="leading-[34px] text-xl font-bold">Fintech</h3>
          </div>
          <div className="industry-tab flex gap-2 cursor-pointer items-center" data-target="ecommerce">
            <div className="indicator w-[4px] h-[34px] bg-[#aaa] rounded-[100px]"></div>
            <h3 className="leading-[34px] text-xl font-bold">E-Commerce</h3>
          </div>
          <div className="industry-tab flex gap-2 cursor-pointer items-center" data-target="healthcare">
            <div className="indicator w-[4px] h-[34px] bg-[#aaa] rounded-[100px]"></div>
        ...
        <div className="relative w-full">
          ...
          <div id="fintech" className="industry-card flex flex-col gap-5 grow">
            ...
            <img className="rounded-3xl max-[393px]:h-[200px]" src="assets/images/Industry Image.png" alt="Industry Image" />
          </div>
          {/* E-Commerce */}
          <div id="ecommerce" className="industry-card flex-col gap-5 grow hidden">
            <p className="leading-8 text-lg font-medium max-[393px]:font-light">
            ...
            <img className="rounded-3xl max-[393px]:h-[200px]" src="assets/images/E-Commerce.png" alt="E-Commerce Image" />
          </div>
          {/* Healthcare */}
          <div id="healthcare" className="industry-card flex-col gap-5 grow hidden">
            <p className="leading-8 text-lg font-medium max-[393px]:font-light">
            ...
            <img className="rounded-3xl max-[393px]:h-[200px]" src="assets/images/Healthcare.png" alt="Healthcare Image" />
          </div>
        </div>
      </div>
    </section>
