...
// A small, reusable component for navigation links.
...
// This keeps the main component clean and organized.
    ...
    <section className="py-10 md:px-[140px] px-4 bg-white dark:bg-black text-black dark:text-white w-full">
      <div className="dark:bg-[#0A0D12] flex flex-col gap-[60px] md:p-10 p-6 bg-[#fafafa] border border-[#dfdfdf] rounded-3xl">
        <div className="md:flex justify-between items-start grid grid-cols-1 gap-4 md:gap-0">
          ...
          {/* LOGO */}
          {/* Using responsive utility classes like `order-2 md:order-1` allows the title and logo to change positions
          for different screen sizes, optimizing the layout. */}
        ...
        <div className="flex justify-between items-start max-[393px]:flex-col md:flex-raw gap-6 md:gap-0">
          {/* NAVIGATION MENU */}
          {/* The `map()` method is a more dynamic and scalable way to render lists. 
          For a static list like this, direct rendering is also fine. */}
